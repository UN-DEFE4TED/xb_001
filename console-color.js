// console.log('%cHello Console', 'color: #fce303')
...
console.log( "\u001b[1;40m hi" );


// Reset text and background color/style to default
console.log( "\u001b[0m Reset text and background color/style to default" );

//color
console.log( "\u001b[1;30m Gray message" );
